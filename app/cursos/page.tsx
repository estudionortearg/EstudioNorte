...
const courses = [
  {
    ...
    priceArs: 25000,
    priceUsd: 25,
    badges: ['IA Práctica', 'Más vendido'],
    isFeatured: true,
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Dejá de usar plantillas genéricas. Aprendé a usar Canva Pro como un diseñador profesional.',
    priceArs: 19000,
    priceUsd: 19,
    badges: ['Canva', 'Diseño'],
    isFeatured: false,
  },
  {
    ...
    subtitle: 'El sistema que uso para conseguir y retener clientes de diseño de marca. Sin publicidad paga.',
    priceArs: 22000,
    priceUsd: 22,
    badges: ['Freelance', 'Negocios'],
    isFeatured: false,
  },
  {
    slug: 'contenido-visual-ia-instagram',
    title: 'Contenido visual con IA para Instagram',
    subtitle: 'Creá imágenes, carruseles y stories profesionales con IA sin saber diseño.',
    priceArs: 18000,
    priceUsd: 18,
    badges: ['Instagram', 'IA'],
    isFeatured: false,
