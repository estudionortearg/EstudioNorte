          ...
          <div className="reveal" style={{ background: 'var(--en-surface)', border: '1.5px solid var(--en-border)', borderRadius: '24px', overflow: 'hidden', boxShadow: 'var(--en-shadow-lg)' }}>
            ...
            <div style={{ padding: '0 32px 32px', position: 'relative' }}>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', color: 'var(--en-text-soft)', margin: '0 0 12px' }}>Diseño · IA · Marca · Contenido · Meta Ads · Automatizaciones · Manychat · Claude</p>
